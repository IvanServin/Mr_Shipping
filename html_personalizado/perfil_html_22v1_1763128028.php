...
?>
<!-- CONTENIDO DEL PERFIL CON COLORES PASTEL -->

<div class="foto-portada">
    <img src="<?php echo $datos_reemplazo['foto_portada']; ?>" alt="Foto de portada" onerror="this.style.display='none'">
</div>

<div class="cabecera">
    <div class="cont_img">
        <img src="<?php echo $datos_reemplazo['foto_perfil']; ?>" alt="Foto de perfil" onerror="this.style.display='none'">
    </div>
    <div class="datos_us">
        <div class="cont_name">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    formsCerrarSesion.forEach(form => {
        form.addEventListener('submit', function(e) {
            ...
            if (botonCerrar) {
                botonCerrar.textContent = 'Cerrando...';
